...
class CatalogWrapper(object):
    ...
    def upload(self, layer, workspace=None, overwrite=True, name=None, enabled=False, inp_title='', description=''):
    ...
    def publishLayer (self, layer, workspace=None, overwrite=True, name=None, style=None, enabled=False, title='', description=''):
        '''
        ...
        self.upload(layer, workspace, overwrite, name, enabled, title, description)
